...
CHAPTERS = {"00": "Control Flow",
            "01": "Data Structures",
            "02": "Functions",
            "03": "Classes",
            "04": "Permutations and Combinations",
            "05": "Logging Errors and Exceptions",
            "06": "Decorators"}
...
if __name__ == '__main__':
    print_contents()
    print('\n', 70 * '#', '\n')
    print_contents('https://nbviewer.jupyter.org/github/nancynobody/python3_fluency/tree/master/notebooks/')